def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.3.0-NOVEMBER-DRY-RUN",
                               "Mule-runtime/mule-api/1.3.0-NOVEMBER-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.3.0-NOVEMBER-DRY-RUN",
                               "Mule-runtime/mule-artifact-ast/0.8.0-NOVEMBER-DRY-RUN",
                               "Mule-runtime/data-weave/master",
                               "Mule-runtime/mule-maven-client/1.5.0-NOVEMBER-DRY-RUN" ]
